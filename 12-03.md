...
#### [Alignment](https://github.com/vgteam/libvgio/blob/master/deps/vg.proto#L109-L151)
...
#### [Mapping](https://github.com/vgteam/libvgio/blob/master/deps/vg.proto#L60-L64)
...
#### [Position](https://github.com/vgteam/libvgio/blob/master/deps/vg.proto#L87-L92)
...
#### [Edit](https://github.com/vgteam/libvgio/blob/master/deps/vg.proto#L50-L54)
...
また、`Mapping` の `from_length` の合計は、ノードの配列中になるし、`Path` の `to_length` の合計は、クエリ配列長になります。
